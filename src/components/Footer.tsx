...
const Footer = () => {
  ...
  return (
    ...
    >
      ...
      {/* Subtle orange glow accent - no filter:blur */}
      ...
      <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="flex gap-3" role="list" aria-label="Redes sociais">
              {links.social.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-lg flex items-center justify-center transition-all duration-300 hover:text-orange-400"
                  style={{
                    color: 'hsl(0 0% 65%)', /* Improved contrast */
                    background: 'hsl(0 0% 10%)',
                    border: '1px solid hsl(0 0% 25%)', /* Improved border contrast */
                  }}
              ...
              {links.services.map((link) => (
                <li key={link.label}>
                  <a
                    ...
                    style={{ color: 'hsl(0 0% 65%)' }} /* Improved contrast */
                  >
                    {link.label}
                  </a>
                </li>
        ...
        <div 
          ...
          style={{
            borderTop: '1px solid hsl(0 0% 18%)', /* Improved border contrast */
          }}
        >
